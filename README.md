...
The dev server proxies `/ch-graphql` to the Cooper Hewitt API so the sandbox works locally. Update the proxy target in `vite.config.js` if you need a different backend.
